...
public class Arduino implements UsbSerialInterface.UsbReadCallback {
    ...
    private static final String ACTION_USB_DEVICE_PERMISSION = "com.example.checkersvisionapp.USB_PERMISSION";
    ...
    public void open(UsbDevice device) {
        PendingIntent permissionIntent = PendingIntent.getBroadcast(context, 0, new Intent(ACTION_USB_DEVICE_PERMISSION),PendingIntent.FLAG_UPDATE_CURRENT|PendingIntent.FLAG_MUTABLE);
